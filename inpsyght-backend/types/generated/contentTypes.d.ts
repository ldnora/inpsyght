...
export interface ApiFacetaFaceta extends Struct.CollectionTypeSchema {
  collectionName: 'facetas';
  info: {
    displayName: 'Faceta';
    pluralName: 'facetas';
    singularName: 'faceta';
...
export interface ApiFatorFator extends Struct.CollectionTypeSchema {
  collectionName: 'fatores';
  info: {
    displayName: 'Fator';
    pluralName: 'fatores';
    singularName: 'fator';
